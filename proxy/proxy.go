...
func setRequestURLForLoadBalancedBackend(u *url.URL, r *http.Request, rt *routing.Route) {
	e := rt.LBAlgorithm.Apply(r, rt.LBEndpoints)
	u.Scheme = e.Scheme
	u.Host = e.Host
}
...
func mapRequest(r *http.Request, rt *routing.Route, host string, removeHopHeaders bool, stateBag map[string]interface{}) (*http.Request, error) {
	...
	case eskip.LBBackend:
		setRequestURLForLoadBalancedBackend(u, r, rt)
	default:
		u.Scheme = rt.Scheme
		u.Host = rt.Host
	}
